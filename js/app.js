(() => {
    ...
    function initSliders() {
        if (document.querySelector(".works-slider__slider")) new core(".works-slider__slider", {
        ...
        if (document.querySelector(".location-slider__slider")) new core(".location-slider__slider", {
        ...
        if (document.querySelector(".testimonials-slider__slider")) new core(".testimonials-slider__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".navigation-testimonials-slider-button-prev",
                nextEl: ".navigation-testimonials-slider-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
